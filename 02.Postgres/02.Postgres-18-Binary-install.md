...
```
./configure --prefix=/u01/pgsql/18.1 --with-systemd --with-openssl

Or,

./configure --prefix=/u01/pgsql/18.1 --with-systemd --with-openssl --with-libxml --with-libxslt --with-uuid=e2fs
```
